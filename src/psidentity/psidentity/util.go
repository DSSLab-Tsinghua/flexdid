...
func (i *Psidentity) MakeNym(sk *math.Zr, IPk *IssuerPublicKey, rng io.Reader, t Translator) (*math.G1, *math.Zr, error) {
...
func (i *Psidentity) MakeNymFromBytes(raw []byte) (*math.G1, *math.Zr, error) {
